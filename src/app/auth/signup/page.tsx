...
export default function SignUp() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      registerSignUp(formData);
    }
  };

  const registerSignUp = (formData: any) => {
    dispatch(
      signUpAction({
        formData,
        onSuccess: (res) => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
